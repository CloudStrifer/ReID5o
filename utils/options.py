...
def get_args():
    parser = argparse.ArgumentParser(description="ReID5o")
    ######################## general settings ########################
    ...
    parser.add_argument("--add_lora", default=False, action='store_true')
    parser.add_argument("--freeze_vision_encoder", default=False, action='store_true')
    parser.add_argument("--lora_r", type=int,default=4)
    parser.add_argument("--num_loras", type=int, default=4)
    parser.add_argument("--lora_layers", type=int, default=2)
    parser.add_argument("--lora_mode", type=str, default='mlp')
    ...
    parser.add_argument("--lora_lr_factor", type=float, default=5.0, help="lr factor for random init LoRAs")
